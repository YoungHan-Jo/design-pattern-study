import { CeilingFanOffCommandWithPrevSpeed, CeilingFanHighCommand, CeilingFanMediumCommand } from "./domain/CeilingFanCommand";
import { CeilingFanOffCommand, CeilingFanOnCommand, GarageDoorOpenCommand, HottubOffCommand, HottubOnCommand, LightOffCommand, LightOnCommand, StereoOffCommand, StereoOnWithCDCommand, TVOffCommand, TVOnCommand } from "./domain/Command";
